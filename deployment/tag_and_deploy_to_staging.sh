...
then
    ...
    rsync -L  backups/latest.dmp staging.djp.djangojobportal.com:/home/web/deployment/backups/
    rsync -r -v media/ staging.djp.djangojobportal.com:/home/web/deployment/media
    ...
    ssh staging.djp.djangojobportal.com "cd /home/web/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
